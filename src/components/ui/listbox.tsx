    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset data-focus:after:ring-2 data-focus:after:ring-kelly-green',
          // Disabled state
