  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-900">Peak Activity Period</p>
          ...
          <div className="text-right">
            ...
            <p className="text-2xl font-bold text-gray-900">{peakHour.total}</p>
      ...
      <div className="grid grid-cols-4 gap-4 pt-6 border-t border-gray-200">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">Total Activity Points</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
            <p className="text-sm font-medium text-gray-700">Radio Users</p>
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <p className="text-sm font-medium text-gray-700">Combined</p>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">Users at {peakHour.time}</p>
        </div>
      </div>
    </div>
  );
