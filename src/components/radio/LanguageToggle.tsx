    ...
    <div className="relative">
      <button
        ...
        className={clsx(
          ...
          "bg-white hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-kelly-green focus:ring-offset-2",
          isOpen ? "border-kelly-green text-kelly-green" : "border-zinc-200 text-zinc-700"
        )}
      >
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-lg border border-zinc-200 overflow-hidden z-20 min-w-[200px]"
            role="listbox"
